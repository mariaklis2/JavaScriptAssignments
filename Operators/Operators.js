...
let numOfDaysUntilWeekend = 2; /* we made x*/
console.log(numOfDaysUntilWeekend) ; /*1*/ /*we printed the number*/
numOfDaysUntilWeekend -= 1; /*we changed the x with subtraction */
